...
const TOUR_INFO = [
  ...
  {
    title: "Deers in Nara",
    description: "A packed day starts with a trip to the small town of Uji, considered the birthplace of matcha tea. This is also the setting for the last ten chapters of the world-renowned Japanese literary work “The Tale of Genji.” After experiencing the calm and steady rhythm of this place and tasting matcha, head to Nara. This city is famous for its free-roaming deer and, of course, Todai-ji Temple – the largest wooden structure in the world.",
    img: day_8_img,
  },
  {
    title: "Mt. Fuji and Hot Springs",
    description:
      "Take the Shinkansen back, but not yet to Tokyo. Instead, to a small village by Lake Kawaguchi, which offers stunning views of Mount Fuji from everywhere. Check into a traditional Japanese ryokan with a hot spring and relax.",
    img: day_9_img,
  },
  {
    title: "Odaiba",
    description:
      "Arrive in Tokyo, leave your luggage at the hotel, and head to Odaiba. This artificial island in Tokyo Bay features beautiful modern architecture, a beach with water access, a mini Statue of Liberty, Rainbow Bridge, and a life-sized Gundam statue. You can easily spend the whole day on Odaiba – there’s an interactive museum of science and innovation (robots and everything that comes to mind with those words), and teamLab, a next-generation digital art museum offering a unique experience.",
    img: day_10_img,
  },
  {
    title: "Departure",
